...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repository = Info.createInstance(getApplicationContext());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(MainActivity.this, Notifications.class));
                startForegroundService(new Intent(MainActivity.this, Notifications.class));
